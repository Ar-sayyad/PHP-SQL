<div class="sidebar-menu">
    ...
    <ul id="main-menu" class="">
       ...
       <li class="<?php if ($page_name == 'manage_pharmacist') echo 'active'; ?> ">
        ...
        <li class="<?php if ($page_name == 'manage_graph' || $page_name =='manage_chemist_graph'
		...
		<!--<li class="<?php if ($page_name == 'manage_chemist_graph') echo 'active'; ?> ">

            <a href="<?php echo base_url(); ?>index.php?admin/chemist_graph">
