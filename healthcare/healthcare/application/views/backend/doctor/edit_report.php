                ...
                <div class="panel-body">
                    ...
                    <form role="form" class="form-horizontal form-groups-bordered" action="<?php echo base_url(); ?>index.php?doctor/report/update/<?php echo $row['report_id']; ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <textarea name="description" required="" class="form-control" id="field-ta"><?php echo $row['description']; ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" name="timestamp" required="" class="form-control datepicker" id="field-1" value="<?php echo date("m/d/Y", $row['timestamp']); ?>">
                            </div>
                        </div>
