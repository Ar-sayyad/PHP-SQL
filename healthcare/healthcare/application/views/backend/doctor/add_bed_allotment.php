                ...
                <form role="form" class="form-horizontal form-groups-bordered" action="<?php echo base_url(); ?>index.php?doctor/bed_allotment/create" method="post" enctype="multipart/form-data">
                            ...
                            <select name="patient_id" required="" class="select2">
                                ...
                                <?php foreach ($patient_info as $row) { 
                                    ...
                                    <option value="<?php echo $row['patient_id']; ?>"
                                            ...
                                            <?php $patientav_info = $this->db->get_where('bed_allotment', array('patient_id' => $row['patient_id'],'discharge_status' => 0))->result_array();

                                            foreach ($patientav_info as $row2) {?>

                                               <?php if ($row['patient_id'] == $row2['patient_id']) echo 'disabled';?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                           ...
                           <input type="text" required="" name="refered_by" class="form-control" id="field-1" >
