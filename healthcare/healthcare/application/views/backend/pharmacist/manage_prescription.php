...
<?php
$patient_info = $this->db->get_where('patient', array('patient_id' => $patient))->result_array();
        ...
        <?php $sr=1; foreach ($prescription_info as $row) { ?>   
            ...
            <td>
                ...
                <td>
                    ...
                    <td>
						<a href="<?php echo base_url();?>index.php?pharmacist/newprescription/delete/<?php echo $row['newpres_id']?>"
