...
--
-- Host: localhost:3306
-- Generation Time: Jan 13, 2018 at 11:15 PM
...
CREATE TABLE IF NOT EXISTS `newprescription` (
  `newpres_id` bigint(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `operator_list` (
  `operator_list_id` bigint(20) NOT NULL AUTO_INCREMENT,
  `receptionist_id` bigint(20) NOT NULL,
  `doctor_id` bigint(20) NOT NULL,
  `createdAt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`operator_list_id`),
...
CREATE TABLE IF NOT EXISTS `test_report` (
  `test_report_id` bigint(20) NOT NULL AUTO_INCREMENT,
  `doctor_id` bigint(20) NOT NULL,
  ...
  KEY `laboratorist_id` (`doctor_id`,`patient_id`)
