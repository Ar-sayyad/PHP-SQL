...
$doctor_info = $this->db->get_where('pharmacist', array('pharmacist_id' => $pharmacist_id))->result_array();
            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-heading">
                    <div class="panel-title">
                        <h4><?php echo get_phrase('pharmacist_details'); ?></h4>
                    </div>
                </div>
                ...
                <div class="panel-body">
					...
					<tr>
						...
						<td><p><?php $name = $this->db->get_where('city' , array('city_id' => $row['city_id'] ))->row()->name;
                          echo $name;?></p></td>
						  <td><b><?php echo get_phrase('medical_name'); ?> :</b></td>
						<td> <p><?php echo $row['med_store_name']; ?></p></td>
...
<?php } ?>
<button onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/add_patient_ph/<?php echo $pharmacist_id;?>');" 
