                    ...
                    <form role="form" class="form-horizontal form-groups-bordered" action="<?php echo base_url(); ?>index.php?admin/patient/create" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
								...
								<input type="hidden" name="doctor_id" required="" value="<?php echo $param2;?>" class="form-control" id="field-1" >
								
								<input type="hidden" name="pharmacist_id" value="" class="form-control" id="field-1" >
