        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" class="form-horizontal form-groups-bordered" action="<?php echo base_url(); ?>index.php?admin/patient/create_chem" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
								...
								<input type="hidden" name="pharmacist_id" required="" value="<?php echo $param2;?>" class="form-control" id="field-1" >
								
								<input type="hidden" name="doctor_id" value="" class="form-control" id="field-1" >
						...
						<div class="form-group">
						<label for="field-1" class="col-sm-3 control-label">Gender <span style="color:red">*</span></label>
						 <div class="col-sm-5 radio-inline">
