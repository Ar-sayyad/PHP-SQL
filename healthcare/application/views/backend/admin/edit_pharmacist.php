            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-heading">
                    <div class="panel-title">
                        <h3><?php echo get_phrase('edit_chemist'); ?></h3>
                    </div>
                </div>
                ...
                <div class="panel-body">
					...
					<div class="form-group">
						...
						<div class="form-group">
                            <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('medical_store_name'); ?> <span style="color:red">*</span></label>

                            <div class="col-sm-5">
                                <input type="text" name="med_store_name" required="" class="form-control" id="field-1" value="<?php echo $row['med_store_name']; ?>">
                            </div>
                        </div>
