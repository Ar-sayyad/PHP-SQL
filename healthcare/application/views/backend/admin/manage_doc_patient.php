        ...
        <?php $sr=1; foreach ($patient_info as $row) { ?>   
            ...
            <tr>
                ...
                <td><?php $name = $this->db->get_where('disease' , array('disease_id' => $row['disease_id'] ))->row()->name;
                        ...
                        echo ucwords($name);?></td>
        <td>
                  <a target="_blank"  href="<?php echo base_url();?>index.php?admin/prescript/<?php echo $row['patient_id']?>" 
					...
					<td>
					 <a target="_blank" href="<?php echo base_url();?>index.php?admin/attachment/<?php echo $row['patient_id']?>" 
