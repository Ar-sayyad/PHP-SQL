        ...
        <table width="100%" border="0">
            <tr>
                ...
                <td align="right" valign="top">						
                    <?php							if(!empty($row['pharmacist_id'])){								$dname = $this->db->get_where('pharmacist' , array('pharmacist_id' => $row['pharmacist_id'] ))->row()->name;
                          echo 'Pharmacist : '.ucwords($dname);							}							else if(!empty($row['doctor_id'])){								$dname = $this->db->get_where('doctor' , array('doctor_id' => $row['doctor_id'] ))->row()->name;                          echo 'Doctor : '.ucwords($dname);							}?><br>
