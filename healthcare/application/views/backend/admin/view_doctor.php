...
$doctor_info = $this->db->get_where('doctor', array('doctor_id' => $param2))->result_array();
            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-heading">
                    <div class="panel-title">
                        <h3><?php echo get_phrase('Doctor_details'); ?></h3>
                    </div>
                </div>
                ...
                <div class="panel-body">
						...
						<b><?php echo get_phrase('speciality'); ?> :</b>
                        
                        <p><?php $name = $this->db->get_where('speciality' , array('speciality_id' => $row['speciality_id'] ))->row()->name;
                          echo $name;?></p>
                        ...
                        <hr>
                        <b><?php echo get_phrase('hospital_name'); ?> :</b>
