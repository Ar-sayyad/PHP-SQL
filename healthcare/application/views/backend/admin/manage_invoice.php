<table class="table table-bordered table-striped datatable" id="table-2">
    <thead>
        <tr>
            ...
            <th><?php echo get_phrase('Admission'); ?></th>
            <th><?php echo get_phrase('discharge'); ?></th>
            <th><?php echo get_phrase('deposit'); ?></th>
    ...
    <tbody>
        <?php foreach ($invoice_info as $row) { ?>   
            <tr>
                ...
                <td><?php if($row['deposit']!=''){ ?><i class="fa fa-inr"></i> <?php echo $row['deposit']; } ?></td>
