...
<th><?php echo get_phrase('prescription');?></th>
 ...
 <td>
                  <a href="<?php echo base_url();?>index.php?doctor/prescript/<?php echo $row['patient_id']?>" 
					...
					<a  onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/new_prescription/<?php echo $row['patient_id']?>');" 
...
<td>
<a href="<?php echo base_url();?>index.php?doctor/attachment/<?php echo $row['patient_id']?>" 
