            ...
            <div class="panel-body">
                ...
                <form role="form" class="form-horizontal form-groups-bordered" action="<?php echo base_url(); ?>index.php?doctor/newprescription/create" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <div class="date-and-time">
                                <input type="text" required="" name="date_timestamp" class="form-control datepicker" data-format="D, dd MM yyyy" placeholder="date here">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="number" required="" name="charges" placeholder="Doctor Charges in Rupees" min="1" class="form-control" id="field-1" >
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text"  name="blood_pressure" placeholder="Blood Pressure"  class="form-control" id="field-1" >
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text"  name="weight" placeholder="Patient Weight in Kg" min="1" class="form-control" id="field-1" >
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text"  name="pulse" placeholder="Enter Pulse" min="1" class="form-control" id="field-1" >
                        </div>
                    </div>
                    <div class="form-group">
