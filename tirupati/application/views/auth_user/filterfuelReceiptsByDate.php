                                        ...
                                        <div class="col-md-4">
                                                <div class="basic-form">
                                                    <div class="form-group">
                                                        <label>From</label>
                                                        <input type="date" name="fromdate"  required="" class="form-control bg-ash" placeholder="dd/mm/yyyy">
                                                    </div>
                                                </div>
                                            </div>
                                              ...
                                              <div class="col-md-4">
                                                <div class="basic-form">
                                                    <div class="form-group">
                                                        <label>To</label>
                                                        <input type="date" name="todate"  required="" class="form-control bg-ash" placeholder="dd/mm/yyyy">
                                                    </div>
                                                </div>
                                            </div>
