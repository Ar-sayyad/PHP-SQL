                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card alert">
                                ...
                                <form action="<?php echo base_url();?>Adminity/vehicles/editVehicle/<?php echo $row['vehicle_id'];?>" method="post">   
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="basic-form">
                                            <div class="form-group">
                                                 ...
                                                 <input type="text" name="seat_type" value="<?php echo $row['seat_type'];?>" class="form-control border-none input-flat bg-ash"  placeholder="Seat Qty">
                                            </div>
                                        </div>
                                    </div>  
                                    <div class="col-md-3">
