                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <div class="col-md-4">
                                                <div class="basic-form">
                                                    <div class="form-group">
                                                        <label>From</label>
                                                        <input type="date" name="fromdate" data-date="" data-date-format="dd/mm/yyyy" required="" class="form-control" placeholder="dd/mm/yyyy">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                                <div class="basic-form">
                                                    <div class="form-group">
                                                        <label>To</label>
                                                        <input type="date" name="todate" data-date="" data-date-format="dd/mm/yyyy" required="" class="form-control bg-ash" placeholder="dd/mm/yyyy">
                                                    </div>
                                                </div>
                                            </div>
