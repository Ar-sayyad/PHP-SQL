                                        ...
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="user-photo m-b-30">
                                                    <img class="img-responsive" src="<?php echo base_url();?>assets/uploads/profile/<?php echo $row->profile_pic;?>" alt="Admin Image Not Set" />
                                                </div>
                                                <div class="user-work">
                                            ...
                                            <div class="col-lg-8">
                                                <div class="user-profile-name"><?php echo $row->admin_name;?></div>
                                                        ...
                                                        <div role="tabpanel" class="tab-pane active" id="1">
                                                            <div class="contact-information">
                                                                ...
                                                                <div class="phone-content">
                                                                    ...
                                                                    <span class="phone-number"><?php echo $row->admin_mobile_no;?></span>
                                                                </div>
                                                                <div class="address-content">
                                                                    <span class="contact-title">Address:</span>
                                                                    <span class="mail-address"><?php echo $row->admin_address;?>-<?php echo $row->pincode;?>, <?php echo $row->city;?>, <?php echo $row->state;?></span>
                                                                </div>
                                                                <div class="email-content">
                                                                    <span class="contact-title">Email:</span>
                                                                    <span class="contact-email"><?php echo $row->admin_email;?></span>
                                                                </div>
