...
<div class="container">
<a href="<?php echo base_url().'Supervisor';?>" id="logo" class="navbar-brand">
...
<?php if($this->session->userdata('supervisor_profile')!=""){?>
 <img src="<?php echo base_url();?>assets/uploads/supervisors/<?php echo $this->session->userdata('supervisor_profile') ?>" alt=""/> 
 <?php
}
?>
<span class="hidden-xs"><?php echo $this->session->userdata('supervisor_email');?></span> <b class="caret"></b>
</a>
<ul class="dropdown-menu dropdown-menu-right">
<li><a href="<?php echo base_url().'Supervisor/profile';?>"><i class="fa fa-user"></i>Profile</a></li> 
<li><a href="<?php echo base_url().'Supervisor/logout';?>"><i class="fa fa-power-off"></i>Logout</a></li>
</ul>
</li>
<li class="hidden-xxs">
<a href="<?php echo base_url().'Supervisor/logout';?>" class="btn">
...
<ul class="submenu">
<li>
<a href="<?php echo base_url().'Supervisor/vehicleType';?>">
<span>Type</span> 
</a>
</li>
<li>
<a href="<?php echo base_url().'Supervisor/vehicleModel';?>">
<span>Model</span> 
</a>
</li>
<li>
<a href="<?php echo base_url().'Supervisor/sparesPart';?>">
<span>Spares</span> 
</a>
</li>
<li>
<a href="<?php echo base_url().'Supervisor/servicingType';?>">
...
<li>
<a href="<?php echo base_url().'Supervisor';?>" class="dropdown-toggle">
<i class="fa fa-wrench"></i>
<span>Basic</span> 
<i class="fa fa-angle-right drop-icon"></i>
</a>
<ul class="submenu">
<li>
<a href="<?php echo base_url().'Supervisor/VehicleOwner';?>">
<span>Vehicle Owner</span> 
</a>
</li>
<li>
<a href="<?php echo base_url().'Supervisor/addVehicle';?>">
<span>Vehicle</span> 
</a>
</li>
<li>
<a href="<?php echo base_url().'Supervisor/driver';?>">
<span>Driver</span> 
</a>
</li>
...
<li>
<a href="<?php echo base_url().'Supervisor/assgin';?>">
<i class="fa fa-users"></i>
<span>Assign Driver To Vehicle</span> 
</a>
</li>
<li>
<a href="<?php echo base_url().'Supervisor/Vendors';?>">
<i class="fa fa-users"></i>
<span>Vendors</span>  
</a>
</li>
<li>
<a href="<?php echo base_url().'Supervisor/assign_fuel';?>">
<i class="fa fa-users"></i>
<span>Fuel Assigned Vehicle</span> 
</a>
</li>
<li>
<a href="<?php echo base_url().'Supervisor/fule_Receipt';?>">
<i class="fa fa-users"></i>
<span>Fuel Receipt</span> 
</a>
</li>
<!-- <li>
<a href="<?php echo base_url().'Supervisor/Supervisor';?>">
<i class="fa fa-users"></i>
...
<!-- <li>
<a href="<?php echo base_url().'Supervisor/vehicleServicing';?>">
<i class="fa fa-users"></i>
<span>Servicing</span> 
</a>
</li> -->
<!-- <li>
<a href="<?php echo base_url().'Supervisor/trip';?>">
<i class="fa fa-users"></i>
<span>Trip</span> 
</a>
</li> -->
<!-- <li>
<a href="<?php echo base_url().'Supervisor/dieselEntry';?>">
<i class="fa fa-users"></i>
<span>Diesel</span> 
</a>
</li> -->
<!-- <li>
<a href="<?php echo base_url().'Supervisor/tyresInfo';?>">
<i class="fa fa-users"></i>
<span>Tyres</span> 
</a>
</li> -->
...
<ul class="submenu">
<li>
<a href="<?php echo base_url().'Supervisor/environment';?>">
Manage Environment
</a>
</li>
 <li>
...
<li>
<a href="<?php echo base_url().'Supervisor/profile';?>">
