...
<a href="<?php echo base_url().'Supervisor/deleteSupervisor/'.$value->supervisor_id;?>" onClick="return doconfirm();" class="table-link danger">
<span class="fa-stack">
<i class="fa fa-square fa-stack-2x"></i>
...
<input type="text" name="supervisor_name" id="supervisor_name" class="form-control" value="<?php echo $value->supervisor_name;?>" placeholder="Enter Name">
</div>

<div class="form-group">
<label for="exampleInputEmail1">Supervisor Email</label>

<input type="email" name="supervisor_email" id="supervisor_email" class="form-control" value="<?php echo $value->supervisor_email;?>" placeholder="Enter Email">
</div>
...
<input type="text" name="supervisor_contact" id="supervisor_contact" class="form-control" value="<?php echo $value->supervisor_contact;?>" placeholder="Enter Contact No" onkeypress="return isNumberKey(event)" maxlength="10" minlength="10">
</div>
<div class="form-group">
<label for="exampleInputEmail1">Alternate  Contact No</label>
<input type="text" name="supervisor_alternet_contact" id="supervisor_alternet_contact" class="form-control" value="<?php echo $value->supervisor_alternet_contact?>" placeholder="Enter Alternate  Contact" onkeypress="return isNumberKey(event)" maxlength="10" minlength="10">
</div>
<div class="form-group">
...
<input type="text" name="supervisor_name" id="supervisor_name" class="form-control"  placeholder="Enter Name">
</div>

<div class="form-group">
<label for="exampleInputEmail1">Supervisor Email</label>

<input type="email" name="supervisor_email" id="supervisor_email" class="form-control"  placeholder="Enter Email">
</div>
<div class="form-group">
...
<div class="form-group">
<label for="exampleInputEmail1">Contact No</label>
<input type="text" name="supervisor_contact" id="supervisor_contact" class="form-control"  placeholder="Enter Contact No" onkeypress="return isNumberKey(event)" maxlength="10" minlength="10">
</div>
<div class="form-group">
<label for="exampleInputEmail1">Alternate Contact No</label>
<input type="text" name="supervisor_alternet_contact" id="supervisor_alternet_contact" class="form-control"  placeholder="Enter Contact No" onkeypress="return isNumberKey(event)" maxlength="10" minlength="10">
</div>
<div class="form-group">
<label for="exampleInputEmail1">Address</label>
