...
<a href="<?php echo base_url().'Supervisor/deleteVehicle/'.$value->vehicle_id;?>" onClick="return doconfirm();" class="table-link danger">
<span class="fa-stack">
<i class="fa fa-square fa-stack-2x"></i>
...
<input type="text" class="form-control" id="editvno" placeholder="Enter Vehicle No" name="vehicle_no" onchange="editval()" required="" value="<?php echo $value->vehicle_no;?>">
...
<input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Vehicle Fuel Limit" name="fuel_limit" value="<?php echo $value->fuel_limit;?>" onkeypress="return isNumberKey(event)" >
</div>
<div class="form-group">
...
<div class="form-group">
<label for="exampleInputEmail1">Vehicle No</label><span style="color:red">*</span>
<input type="text" required="" class="form-control" id="vno" placeholder="Enter Vehicle No" name="vehicle_no" onchange="val()">
</div>
 <div class="form-group">
