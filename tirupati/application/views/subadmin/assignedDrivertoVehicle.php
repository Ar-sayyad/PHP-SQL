               ...
               <!---page title-->
                ...
                <section id="main-content">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="addbtn">
                                <button data-toggle="modal" onclick="showAjaxModal('<?php echo base_url();?>Subadmin/popup/subadmin/assignDriverToVehicle');" class="btn btn-primary" >Assign Driver to Vehicle</button>
                             </div>
