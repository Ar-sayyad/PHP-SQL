               ...
               <!---page title-->
                ...
                <section id="main-content">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
<!--                            <div class="addbtn">
                                <button data-toggle="modal" onclick="showAjaxModal('<?php echo base_url();?>Subadmin/popup/myadmin/assignVehToFuel');" class="btn btn-primary" >Add Subadmin</button>
                             </div>-->
                                        ...
                                        <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td> <a data-toggle="tooltip" class="table-link" style="cursor:pointer">                                                    
                                                     <?php echo $row->otp;?>
                                                     </a></td>
                                                    <td style="text-align: left">
                                                        <a data-toggle="tooltip" style="cursor:pointer" onclick="showAjaxModal('<?php echo base_url();?>Subadmin/popup/myadmin/viewVehicleToFuel/<?php echo $row->fuel_mgt_id;?>');" class="table-link">
                                                   ...
                                                   <a data-toggle="tooltip" title="" href="<?php echo base_url(); ?>Subadmin/vehiclestoFuel/delete/<?php echo $row->fuel_mgt_id;?>" class="table-link danger">
