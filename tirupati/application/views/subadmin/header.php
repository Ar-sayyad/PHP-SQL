...
<!--                <li class="header-icon dib"><i class="fa fa-inr"></i>
                                    ...
                                    <a href="#">
                                        ...
                                        <div class="notification-content">
                                            ...
                                            <div class="notification-text" style="float:right">
                                                <button class="btn editbtn btn-info" onclick="showAjaxModal('<?php echo base_url();?>Subadmin/popup/myadmin/editVendorRate/<?php echo $vend['vendor_id'];?>');" id="edit_rate<?php echo $vend['vendor_id'];?>">Edit Rate
                                                </button>
                                            </div>
                ...
                <li class="header-icon dib">
                    <img class="avatar-img" src="<?php echo base_url();?>assets/uploads/subadmin/<?php echo $this->session->userdata('log_image');?>" alt="" /> 
                    <span class="user-avatar"><?php echo $this->session->userdata('log_admin_name');?> <i class="ti-angle-down f-s-10"></i></span>
                    <div class="drop-down dropdown-profile">                        
                        <div class="dropdown-content-body">
                            <ul>
                                <li><a href="<?php echo base_url();?>Subadmin/profile"><i class="ti-user"></i> <span>Profile</span></a></li>
                                <li><a href="<?php echo base_url();?>Subadmin/profile"><i class="ti-settings"></i> <span>Setting</span></a></li>
                                <li><a href="<?php echo base_url();?>Subadmin/logout"><i class="ti-power-off"></i> <span>Logout</span></a></li>
                            </ul>
                        </div>
                    </div>
                </li>
