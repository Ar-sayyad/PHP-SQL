                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card alert">
                                ...
                                <form action="<?php echo base_url();?>Subadmin/subadmin/editSubadmin/<?php echo $row['subadmin_id'];?>" method="post">   
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="basic-form">
                                            <div class="form-group">
                                                    ...
                                                    <input type="text"  name="subadmin_contact" value="<?php echo $row['subadmin_contact'];?>"  required="" pattern="[0-9]{10,10}" maxlength="10" minlength="10"  class="form-control border-none input-flat  bg-ash" placeholder="Contact Number">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="basic-form">
                                            <div class="form-group">
                                                    ...
                                                    <input type="email"  name="subadmin_email" value="<?php echo $row['subadmin_email'];?>" readonly required="" class="form-control border-none input-flat  bg-ash" placeholder="Email Address">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
