               ...
               <!---page title-->
                ...
                <section id="main-content">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="addbtn">
                                <button data-toggle="modal" onclick="showAjaxModal('<?php echo base_url();?>Subadmin/popup/subadmin/addVehicle');"  class="btn btn-primary" >Add Vehicle</button>
                             </div>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: left">
                                                        <a style="cursor:pointer" onclick="showAjaxModal('<?php echo base_url();?>Subadmin/popup/subadmin/viewVehicle/<?php echo $row->vehicle_id;?>');" class="table-link">
                                                        <span  class="fa-stack">
                                                        ...
                                                        <a style="cursor:pointer" onclick="showAjaxModal('<?php echo base_url();?>Subadmin/popup/subadmin/editVehicle/<?php echo $row->vehicle_id;?>');" class="table-link">
                                                        <span  class="fa-stack">
                                                        <i class="fa fa-square fa-stack-2x"></i>
