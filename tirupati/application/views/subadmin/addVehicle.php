                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card alert">
                                ...
                                <form action="<?php echo base_url();?>Subadmin/vehicles/addVehicle" method="post">   
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="basic-form">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control border-none input-flat bg-ash"  placeholder="Vehicle Description" rows="3" name="description"></textarea>
                                            </div>
                                        </div>
                                    </div>                        
