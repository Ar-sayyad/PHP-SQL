...
$owner = $this->db->get_where('vehicle_owner',array('own_diesel_filler' => 1))->result_array();
?>
<!-- Styles -->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card alert">
                                ...
                                <form action="<?php echo base_url();?>Adminity/dieselVehicles/addVehicle" method="post">   
                                <div class="row">
                                    <div class="col-md-6">
