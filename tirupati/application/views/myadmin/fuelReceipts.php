                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: left">
                                                        <a data-toggle="tooltip" style="cursor:pointer" onclick="showAjaxModal('<?php echo base_url();?>Adminity/popup/myadmin/viewFuelReceipt/<?php echo $row->fuel_receipt_id;?>');" class="table-link">
                                                    ...
                                                    <!--<a data-toggle="tooltip" title="Release Vehicle" href="<?php echo base_url(); ?>Adminity/vehiclestoFuel/delete/<?php echo $row->fuel_mgt_id;?>" class="table-link danger">
