            ...
            <div class="nano-content">
                <ul>
                    ...
                    <?php if($page_title=='Diesel Owners'){?>
                            <li class="active">
                            <?php } else { ?><li> <?php }?>
                                <a href="<?php echo base_url();?>Adminity/dieselOwners"><i class="fa fa-user"></i>Diesel Owners</a>
                            </li>
                            <?php if($page_title=='Diesel Vehicles'){?>
                            <li class="active">
                            <?php } else { ?><li> <?php }?>
                                <a href="<?php echo base_url();?>Adminity/dieselVehicles"><i class="ti-car"></i>Diesel Vehicles</a>
                            </li>
                            <?php if($page_title=='Summation'){?>
                            <li class="active">
                            <?php } else { ?><li> <?php }?>
                                <a href="<?php echo base_url();?>Adminity/summation"><i class="ti-plus"></i>Summation</a>
                            </li>
                            <?php if($page_title=='Sum List'){?>
                            <li class="active">
                            <?php } else { ?><li> <?php }?>
                                <a href="<?php echo base_url();?>Adminity/sumList"><i class="fa fa-plus-circle"></i>Sum List</a>
                            </li>
                        </ul>
                      </li>
