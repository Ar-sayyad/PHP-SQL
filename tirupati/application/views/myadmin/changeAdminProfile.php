                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-8">
                                            <div class="basic-form">
                                                <div class="form-group">
                                                    <input type="text" name="admin_name" required="" class="form-control" value="<?php echo $row['admin_name'];?>" placeholder="Name"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-8">
                                            <div class="basic-form">
                                                <div class="form-group">
                                                    <input type="email" name="admin_email" required="" readonly class="form-control" value="<?php echo $row['admin_email'];?>" placeholder="Email Address"/>
                                                </div>
                                            </div>
                                        </div>                                        
                                        ...
                                        <div class="col-md-8">
                                            <div class="basic-form">
                                                <div class="form-group">
                                                    <input type="text" name="admin_mobile_no" required="" class="form-control" pattern="[0-9]{10,10}" maxlength="10" minlength="10" value="<?php echo $row['admin_mobile_no'];?>" placeholder="Contact Number"/>
                                                </div>
                                            </div>
                                        </div>                                        
                                            <div class="col-md-4">
                                        ...
                                        <div class="col-md-8">
                                            <div class="basic-form">
                                                <div class="form-group">
                                                    <input type="text" name="admin_alternatemobile" class="form-control" pattern="[0-9]{10,10}" maxlength="10" minlength="10" value="<?php echo $row['admin_alternatemobile'];?>" placeholder="Alternate Contact Number"/>
                                                </div>
                                            </div>
                                        </div>                                        
                                            <div class="col-md-4">
                                        ...
                                        <div class="col-md-8">
                                            <div class="basic-form">
                                                <div class="form-group">
                                                    <textarea name="admin_address" class="form-control" placeholder="Address"><?php echo $row['admin_address'];?></textarea>
                                                </div>
                                            </div>
                                        </div>
