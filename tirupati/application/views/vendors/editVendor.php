                                    ...
                                    <div class="col-md-6">
                                        <div class="basic-form">
                                            <div class="form-group">
                                                    ...
                                                    <input type="email"  name="vendor_email" value="<?php echo $row['vendor_email'];?>" required="" class="form-control border-none input-flat  bg-ash" placeholder="Email Address">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
