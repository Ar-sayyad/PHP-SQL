                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card alert">
                                ...
                                <form action="<?php echo base_url();?>Vendor/profile/updateImage/<?php echo $row['vendor_id'];?>" method="post" enctype="multipart/form-data">   
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="col-md-4">
                                            ...
                                            <div class="basic-form">
                                                <div class="form-group">
                                                        <div class="user-photo m-b-20">
                                                            <img class="img-responsive" style="width: 250px;" src="<?php echo base_url();?>assets/uploads/vendors/<?php echo $row['profile_pic'];?>" alt="Vendor Image Not Set" />
                                        ...
                                        <div class="col-md-4">
                                         ...
                                         <div class="col-md-8">
                                            <div class="basic-form">
                                                <div class="form-group">
                                                    <input type="file" name="vendors" value="" required="" class="form-control border-none input-flat bg-ash" placeholder="Profile Image">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
