...
<h2><?php echo $this->session->userdata('admin_email'); ?></h2>
</header>
<div class="main-box-body clearfix">

 <img src="<?php echo base_url();?>assets/uploads/profile/<?php echo $profile[0]->profile_pic ?>" alt="" class="profile-img img-responsive center-block"/>
<div class="profile-details">
<ul class="fa-ul">
<li><i class="fa-li fa fa-phone"></i>: <span><?php echo $profile[0]->admin_mobile_no;?></span></li>
<li><i class="fa-li fa fa-envelope"></i>: <span><?php echo $profile[0]->admin_email;?></span></li>
<li><i class="fa-li fa fa-map-marker"></i>: <span><?php echo $profile[0]->admin_address;?></span></li>
</ul>
</div>
</div>
</div>
...
<input type="text" class="form-control" id="exampleInputPassword1" placeholder="Name" name="admin_name" value="<?php echo $profile[0]->admin_name;?>" onKeyPress="return ValidateAlpha(event);">
</div>
<div class="form-group">
<label for="exampleTextarea">Email</label>
<input type="email" class="form-control" id="exampleInputPassword1" placeholder="Email" name="admin_email" value="<?php echo $profile[0]->admin_email;?>" readonly>
</div>
<div class="form-group">
<label for="exampleTextarea">Address</label>
<textarea class="form-control" rows="2" placeholder="Address" name="admin_address"><?php echo $profile[0]->admin_address;?></textarea>
</div>
</div>
<div class="col-md-6">
<div class="form-group">
<label for="exampleTextarea">Mobile</label>
<input type="text" class="form-control" id="exampleInputPassword1" placeholder="Mobile" name="admin_mobile_no" value="<?php echo $profile[0]->admin_mobile_no;?>" onkeypress="return isNumberKey(event)" readonly>
</div>
<div class="form-group">
<label for="exampleTextarea">Alternate Mobile</label>
<input type="text" class="form-control" id="exampleInputPassword1" placeholder="Mobile" name="admin_alternatemobile" value="<?php echo $profile[0]->admin_alternatemobile;?>" onkeypress="return isNumberKey(event)">
</div> 
<div class="form-group">
<label for="exampleTextarea">Profile</label>
<input type="file" class="form-control" id="exampleInputPassword1" name="admin_profile">
<input type="hidden" class="form-control" id="exampleInputPassword1" name="old_admin_profile" value="<?php echo $profile[0]->profile_pic;?>" >
</div>
<div class="form-group"> 
...
<div class="col-md-6">
<div class="form-group">
<label for="exampleTextarea">Old Password</label>
