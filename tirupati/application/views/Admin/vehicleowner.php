...
<a href="<?php echo base_url().'home/deleteOwner/'.$value->vehicle_owner_id;?>" onClick="return doconfirm();" class="table-link danger">
<span class="fa-stack">
<i class="fa fa-square fa-stack-2x"></i>
...
<!--<div class="form-group">
	<label class="control-label no-padding-right" for="form-field-1">ID Proof</label>
		<div class="col-sm-9">
			<input type="file"  class="form-control hidden" id="id_proof2" name="id_proof" >
			<span class="profile-picture">
			<img id="avatar4" style="height:150px;" class="	editable img-responsive" alt="Alex's Avatar" src="<?php echo base_url();?>assets/uploads/driver/id_proof/<?php echo $value->id_proof ?>"  onError="this.src ='<?php echo base_url().'assets/img/uploadimg.png';?>'" />
			<input type="hidden" class="form-control" id="old_id_proof" name="old_id_proof" value="<?php echo $value->id_proof;?>">
			</span> 
		</div>
</div>-->
</div>
...
<!-- <div class="form-group">
	<label class="control-label no-padding-right" for="form-field-1">License</label>
		<div class="col-sm-9">
			<input type="file"  class="form-control hidden" id="license1" name="license" >
			<span class="profile-picture">
			<img id="avatar1" style="height:150px;" class="	editable img-responsive" alt="Alex's Avatar" src="<?php echo base_url().'assets/img/uploadimg.png';?>" />
			</span> 
		</div>
</div> -->
</div>
...
<!-- <div class="form-group">
	<label class="control-label no-padding-right" for="form-field-1">ID Proof</label>
		<div class="col-sm-9">
			<input type="file"  class="form-control hidden" id="id_proof1" name="id_proof" >
			<span class="profile-picture">
			<img id="avatar2" style="height:150px;" class="	editable img-responsive" alt="Alex's Avatar" src="<?php echo base_url().'assets/img/uploadimg.png';?>" />
