...
<a href="<?php echo base_url().'home/deleteDriver/'.$value->driver_id;?>" onClick="return doconfirm();" class="table-link danger">
<span class="fa-stack">
<i class="fa fa-square fa-stack-2x"></i>
...
<input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Full Name" name="drivername" value="<?php echo $value->driver_name;?>" onKeyPress="return ValidateAlpha(event);" required>
</div>
<div class="form-group">
...
<div class="form-group">
<label for="exampleInputEmail1">Name</label><span style="color:red">*</span>
<input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Full Name" name="drivername" onKeyPress="return ValidateAlpha(event);" required="">
</div>
<div class="form-group">
<label for="exampleTextarea">Address</label>
