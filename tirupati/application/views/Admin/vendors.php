...
<td>
	<a href="#vendoreditmodal_<?php echo $value->vendor_id;?>" data-toggle="modal" class="table-link">
<span class="fa-stack">
<i class="fa fa-square fa-stack-2x"></i>
<i class="fa fa-pencil fa-stack-1x fa-inverse"></i>
</span>
</a>
<a href="<?php echo base_url().'home/deleteVendor/'.$value->vendor_id;?>" onClick="return doconfirm();" class="table-link danger">
<span class="fa-stack">
<i class="fa fa-square fa-stack-2x"></i>
...
<input type="text" name="GST_NO" id="GST_NO" class="form-control"  placeholder="Enter GSTIN NO" value="<?php echo $value->GST_NO;?>">
</div>
...
<input type="text" name="vendor_alternate_contact" id="vendor_alternate_contact" class="form-control" value="<?php echo $value->vendor_alternate_contact?>" placeholder="Alternate  Contact" onkeypress="return isNumberKey(event)" maxlength="10" minlength="10">
</div>
<div class="form-group">
...
<input type="password" name="vendor_cpass" id="vendor_cpass" class="form-control"  placeholder="Enter Password" required="" onchange="checkpass();">
</div>
...
<input type="text" name="GST_NO" id="GST_NO" class="form-control"  placeholder="Enter GSTIN NO">
</div>
<div class="form-group">
<label for="exampleInputEmail1">Address</label>
	...
	function checkpass(value)
{
  ...
  var value = document.getElementById("vendor_cpass").value;
  var value1 = document.getElementById("vendor_pass").value;
 if(value1!= value)
    {
