				...
				<div id="content_wrapper">
					...
					<div id="content" class="container-fluid">
						<div class="content-body">
                                 ...
                                 <a href="<?php echo base_url();?>Theme/assets/upload/downloads/FormatFile.xlsx" class="btn btn-info" style="float: right" ><i class="zmdi zmdi-download"></i> Download Format</a>
