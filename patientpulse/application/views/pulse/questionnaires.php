				...
				<div id="content_wrapper">
					...
					<div id="content" class="container-fluid">
						<div class="content-body">
                                                        ...
                                                        <div class="row">
                                                            <div class="addbtn">
                                                             <button data-toggle="modal" onclick="showAjaxModal('<?php echo base_url();?>home/popup/pulse/under');" class="btn btn-primary" style="float: right" > <i class="zmdi zmdi-plus-circle-o"></i> Add Question</button>
                                                           </div>
                                                                <div class="col-md-12">
                                                                    <div class="card">
