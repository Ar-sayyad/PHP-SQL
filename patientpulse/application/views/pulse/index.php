				...
				<div id="content_wrapper">
					...
					<div id="content" class="container-fluid">
						<div class="content-body">							
							<div class="row">
                                                            <div class="col-md-3">
                                                                    <div class="card hosp_sect">
                                                                            <div class="card-body p-b-0">
                                                                                <h1> <i class="zmdi zmdi-hospital-alt"></i></h1>
                                                            ...
                                                            <div class="col-md-3">
                                                                    <div class="card quest_sect">
                                                                            <div class="card-body p-b-0">
                                                                                <h1><i class="zmdi zmdi-help-outline"></i></h1>
                                                            ...
                                                            <div class="col-md-3">
                                                                    <div class="card nps_sect">
                                                                            <div class="card-body p-b-0">
                                                                                <h1><i class="zmdi zmdi-chart"></i></h1>
                                                                                <h2>Average NPS</h2>
                                                                                <hr> <hr>
                                                                                <h3>6.8%</h3>
                                                                            </div>										
							...
							<!-- ENDS $dashboard_content -->
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                    <div class="card score_dimensions">
                                                                            <div class="card-body p-b-0">
                                                                                <div id="score_dimensions">
                                                                                ...
                                                                                <table class="table table-bordered table-striped">
                                                                                    ...
                                                                                    <tbody>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td>
                                                                                                Environment - Cleanliness, Noise, etc.
                                                                                            </td>
                                                                                            <td>
                                                                                                XX
                                                                                            </td>
