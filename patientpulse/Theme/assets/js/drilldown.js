...
(function(n) {
    ...
    (function(d) {
        ...
        m.prototype.addSingleSeriesAsDrilldown =
            function(a, b) {
                var c = a.series,
                    e = c.xAxis,
                    f = c.yAxis,
        ...
        m.prototype.showDrillUpButton = function() {
            ...
            this.drillUpButton ? this.drillUpButton.attr({
                text: b
            }).align() : (f = (e = c.theme) && e.states, this.drillUpButton = this.renderer.button(b,
                null, null,
                function() {
                    a.drillUp()
            ...
            if (this.drilldownLevels && 0 !== this.drilldownLevels.length) {
                for (var a = this, b = a.drilldownLevels, c = b[b.length - 1].levelNumber, e = b.length, f = a.series, g, h, d, l, m = function(b) {
                    ...
                    if (h = b[e], h.levelNumber === c) {
                        ...
                        d.remove(!1);
                        l.xAxis && (g = h.oldExtremes, l.xAxis.setExtremes(g.xMin, g.xMax, !1), l.yAxis.setExtremes(g.yMin, g.yMax, !1));
        ...
        p.prototype.animateDrilldown = function(a) {
            var b = this,
                ...
                e, d = n(this.chart.options.drilldown.animation),
                g = this.xAxis;
            a || (k(c, function(a) {
        ...
        p.prototype.animateDrillupFrom =
            function(a) {
                var b = n(this.chart.options.drilldown.animation),
                    c = this.group,
