...
<title>Auto IT | Forgot Password </title>
...
<p><?php if($errors){ echo '<center style="color:red">'.$errors.'</center>'; }
elseif ($this->session->flashdata('msg')){ echo '<center style="color:green">'. $this->session->flashdata('msg').'</center>';
 $this->session->set_flashdata('msg', ''); }else{
echo 'Enter your email address to recover your password.'; } ?>
</p>
<form role="form" method="post" action="<?php echo base_url();?>index.php/TestApp/validateForgotPassword">
