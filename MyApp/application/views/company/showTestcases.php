...
<header class="main-box-header clearfix">
 <?php if ($this->session->flashdata('msg')){?>
   <p id="mssg" style="margin-bottom:0px;margin-top:5px;color: green;text-align: center;background-color: #fff; width: 75%;margin-left: 100px;padding: 7px; border: 1px solid green;border-radius: 2px;">
...
<?php $this->session->set_flashdata('msg', '');}?>
  ...
  <p id="mssg" style="margin-bottom:0px;margin-top:5px;color: RED;text-align: center;background-color: #fff; width: 75%;margin-left: 100px;padding: 7px; border: 1px solid red;border-radius: 2px;">
        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">
...
<td><?php echo $this->test_model->get_test_application($row['application_id']);?></td>
...
<!--<td><?php echo $this->test_model->get_test_status($row['status_type']);?></td>-->
...
<a  href="<?php echo base_url(); ?>index.php/testapp/testCases/delete/<?php echo $row['testcase_id'];?>" class="table-link danger">
