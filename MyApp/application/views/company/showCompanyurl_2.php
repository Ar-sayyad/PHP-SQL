...
<table class="table">
	<thead>
		<tr>
			...
			<th>Environment</th>
                        <?php  foreach ($companyurl_info as $row1) { ?>    
				<th><?php echo $appname= $this->test_model->get_test_application($row1['application_id']);?></th>
			<?php } ?>
...
<?php foreach ($environment_info as $env1) { ?>
    <td><?php echo $env1['environment_name']; ?></td>
...
<a  href="<?php echo base_url(); ?>index.php/Testapp/companyUrl/delete/<?php echo $env1['environment_id'];?>" class="table-link danger">
