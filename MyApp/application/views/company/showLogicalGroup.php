...
<?php $this->session->set_flashdata('msg', '');}?> 
    ...
    <form method="post" action="<?php echo base_url();?>index.php/TestApp/startGroupExecution/TestApp">           
...
<table id="table-example" class="table table-hover">
        ...
        <thead>
			...
			<a  style="cursor:pointer" title="Delete Group" href="<?php echo base_url(); ?>index.php/TestApp/LogicalGroup/delete/<?php echo $row['logical_group_id'];?>" class="table-link danger">
