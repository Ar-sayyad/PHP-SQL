...
<h2><b><?php echo $row['company_name'];?></b></h2>
</header>
...
<div id="newsfeed">
 <form role="form" action="<?php echo base_url(); ?>index.php/Testapp/updateProfile/<?php echo $row['company_id'];?>" method="post">
<div class="row">
<div class="col-md-6">
<div class="form-group">
<label for="exampleTextarea">Name</label> <span style="color:red">*</span>
<input type="text" class="form-control" id="company_name" required  name="company_name" value="<?php echo $row['company_name'];?>" placeholder="Company name">
</div>
<div class="form-group">
...
<input type="text" class="form-control" name="contact"  id="contact" pattern="[0-9]{10,10}"  autocomplete="off" maxlength="10" value="<?php echo $row['contact'];?>" placeholder="Mobile">
</div>
<div class="form-group">
...
<div id="newsfeed">
 <form role="form" action="<?php echo base_url(); ?>index.php/Testapp/updatePassword/<?php echo $row['company_id'];?>" method="post">
<div class="row">
<div class="col-md-6">
<div class="form-group">
...
<h5><strong><?php echo $rows['username'];?></strong></h5>
</div> 
<div class="form-group">
...
<?php } ?>
<div class="col-md-4">
<a onclick="showAjaxModal('<?php echo base_url();?>index.php/modal/popup/edit_mailsetting/<?php echo $row['company_id'];?>');" class="table-link" style="cursor:pointer">
<span class="fa-stack">
<i class="fa fa-square fa-stack-2x"></i>
<i class="fa fa-pencil fa-stack-1x fa-inverse"></i>
</span>
