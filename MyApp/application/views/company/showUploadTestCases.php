  ...
  <div class="col-md-7">
    <div id="uploadFile">
        ...
        <!--<form role="form"  enctype="multipart/form-data" method="post" action="<?php echo base_url();?>index.php/TestApp/do_upload">-->
            ...
            <input type="file" name="userfile" required="" size="20"  class="form-control">
   ...
   /* 
		...
		$("#value_show_text"+i).val(exploade[i]+ " "+check_name_validation);					 	
			...
			function show_selected_app_test(application_id){
				...
				$.post('<?php echo base_url();?>index.php/TestApp/check_testcase_data', { application_id: $application_id }, function(data){
					//alert(data);
					$("#filetest").html(data);
                                         $("#filenameshow").hide();
				});	
