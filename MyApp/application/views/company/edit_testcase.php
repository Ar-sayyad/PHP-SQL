<?php $company_id        = $this->session->userdata('login_user_id');
        ...
        <div class="" data-collapsed="0">
            ...
            <div class="panel-heading">
             ...
             <div class="panel-body">
              ...
              <form role="form" class="form-horizontal form-groups-bordered" action="<?php echo base_url(); ?>index.php/testapp/testCases/update/<?php echo $row['testcase_id'];?>" method="post" enctype="multipart/form-data">
...
<!--					<div class="col-md-6">
					 ...
					 <div class="form-group" style="float:right;margin-top: -25px">
                                                <button type="submit" id="" class="btn btn-primary">Update Test Case</button>
                                            </div>
