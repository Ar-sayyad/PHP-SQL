        ...
        <div class="" data-collapsed="0">
            ...
            <div class="panel-heading">
             ...
             <div class="panel-body">
              ...
              <form role="form" class="form-horizontal form-groups-bordered" action="<?php echo base_url(); ?>index.php/testapp/users/update/<?php echo $row['user_id'];?>" method="post" enctype="multipart/form-data">
