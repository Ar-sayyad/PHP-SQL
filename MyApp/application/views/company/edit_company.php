        ...
        <div class="" data-collapsed="0">
            ...
            <div class="panel-heading">
             ...
             <div class="panel-body">
              ...
              <form role="form" class="form-horizontal form-groups-bordered" action="<?php echo base_url(); ?>index.php/Testapp/company/update/<?php echo $row['company_id'];?>" method="post" enctype="multipart/form-data">
					...
					<div class="row">
						...
						<div class="col-md-6">
							...
							<input type="text" class="form-control" id="usercontact" value="<?php echo $row['contact'];?>" required name="contact" pattern="[0-9]{10,10}"  autocomplete="off" maxlength="10" placeholder="Enter Contact No">
							</div>
