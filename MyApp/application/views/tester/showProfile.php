...
<div id="newsfeed">
 <form role="form" action="<?php echo base_url(); ?>index.php/Tester/updateProfile/<?php echo $row['user_id'];?>" method="post">
<div class="row">
<div class="col-md-6">
...
<div id="newsfeed">
 <form role="form" action="<?php echo base_url(); ?>index.php/Tester/updatePassword/<?php echo $row['user_id'];?>" method="post">
<div class="row">
<div class="col-md-6">
<div class="form-group">
