...
<title>Auto IT | Password Reset Successfully</title>
...
<h4 style="color:green">Password Reset Successfully.!</h4>
...
<div class="input-group reset-pass-input">
		...
		<button class="btn btn-success col-xs-12">Login Now</button></a>
		</div>
		</div>
