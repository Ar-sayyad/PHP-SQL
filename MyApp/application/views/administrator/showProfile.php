...
<div id="newsfeed">
 <form role="form" action="<?php echo base_url(); ?>index.php/Administrator/updateProfile/<?php echo $row['user_id'];?>" method="post">
<div class="row">
<div class="col-md-6">
<div class="form-group">
<label for="exampleTextarea">First Name</label> <span style="color:red">*</span>
<input type="text" class="form-control" id="fname" required  name="fname" value="<?php echo $row['fname'];?>" placeholder="First name">
</div>
   <div class="form-group">
<label for="exampleTextarea">Last Name</label> <span style="color:red">*</span>
<input type="text" class="form-control" id="lname" required  name="lname" value="<?php echo $row['lname'];?>" placeholder="First name">
</div>
<div class="form-group">
...
<div id="newsfeed">
 <form role="form" action="<?php echo base_url(); ?>index.php/Administrator/updatePassword/<?php echo $row['user_id'];?>" method="post">
<div class="row">
<div class="col-md-6">
<div class="form-group">
