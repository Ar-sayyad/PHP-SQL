...
<a onclick="showAjaxModal('<?php echo base_url();?>index.php/modal/popup/add_browser/');" class="btn btn-primary pull-right">
<i class="fa fa-plus-circle fa-lg"></i> Add Browser
</a>
</header>
...
<tbody>
<?php $sr=1; foreach ($browser_info as $row) { ?>   
<tr>
<td><?php echo $sr;?></td>
<td><?php echo ucfirst($row['browser_name']);?></td>

<td><?php echo $row['createdAt'];?></td>
<td>
<a style="cursor:pointer" onclick="showAjaxModal('<?php echo base_url();?>index.php/modal/popup/edit_browser/<?php echo $row['browser_id'];?>');" class="table-link">
<span  class="fa-stack">
<i class="fa fa-square fa-stack-2x"></i>
<i class="fa fa-pencil fa-stack-1x fa-inverse"></i>
</span>
</a>
<a  href="<?php echo base_url(); ?>index.php/Administrator/testBrowser/delete/<?php echo $row['browser_id'];?>" class="table-link danger">
