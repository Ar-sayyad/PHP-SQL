 ...
 <div class="row">
    ...
    <div class="col-md-12 col-xs-12 col-lg-12">
        ...
        <div class="panel-body">
			...
			<form role="form" method="post" action="<?php echo base_url();?>index.php/Administrator/companyUrl/update/<?php echo $com['company_env_id'];?>" method="post" enctype="multipart/form-data">
