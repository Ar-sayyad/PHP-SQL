...
<a onclick="showAjaxModal('<?php echo base_url();?>index.php/modal/popup/add_application/');" class="btn btn-primary pull-right">
<i class="fa fa-plus-circle fa-lg"></i> Add Application
</a>
</header>
...
<tbody>
<?php $sr=1; foreach ($application_info as $row) { ?>   
<tr>
<td><?php echo $sr;?></td>
<td><?php echo ucfirst($row['application_name']);?></td>

<td><?php echo $row['createdAt'];?></td>
<td>
<a style="cursor:pointer" onclick="showAjaxModal('<?php echo base_url();?>index.php/modal/popup/edit_application/<?php echo $row['application_id'];?>');" class="table-link">
<span  class="fa-stack">
<i class="fa fa-square fa-stack-2x"></i>
<i class="fa fa-pencil fa-stack-1x fa-inverse"></i>
</span>
</a>
<a  href="<?php echo base_url(); ?>index.php/Administrator/testApplication/delete/<?php echo $row['application_id'];?>" class="table-link danger">
